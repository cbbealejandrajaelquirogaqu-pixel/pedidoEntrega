...
app.config['SQLALCHEMY_DATABASE_URI'] = \
    '{SGBD}://{usuario}:{clave}@{servidor}/{database}'.format(
        ...
        usuario = 'Al3jael25',
        clave = 'Maracuya25',
        servidor = 'Al3jael25.mysql.pythonanywhere-services.com',
        database = 'Al3jael25$pedidoEntrega'
    )
...
class Productos(db.Model):
    __tablename__ = 'productos'  # Nombre explícito de la tabla
...
def login():
    if request.method == 'POST':
        ...
        if registro_usuario.clave == password:
...
def ver_mapa():
    ...
    path='/home/Al3jael25/mysite/static/mapa_cbb.html'
    m.save(path)
